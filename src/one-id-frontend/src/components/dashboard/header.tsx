...
function Header() {
	...
	return (
		<header className='flex items-center justify-between pt-8 h-full gap-6 w-[75%] mx-auto'>
			...
			<div className='flex items-center gap-14 text-gray-400 text-sm absolute left-1/2 -translate-x-1/2'>
